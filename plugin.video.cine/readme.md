 ...
 * [:rocket: 快速适配支持maccms采集的网站 `cine 0.2.0+版本 支持`](#rocket-快速适配支持maccms采集的网站-cine-020--支持)
   * [get_maccms_xxx(api,url,keyword,page,banid,debug)函数](#get_maccms_xxxapiurlkeywordpagebaniddebug)
   * [快速适配采集站示例](#快速适配采集站示例)
 * [:gear: 内置函数](#gear-内置函数)
   * [get_html()](#get_html)
   * [post_html()](#post_html)
...
```
---
## 	:rocket: 快速适配支持maccms采集的网站 `cine 0.2.0 + 支持`
